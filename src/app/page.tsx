    ...
    <>
      <div className="relative w-full h-[500px]">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full text-white">
          <h1 className="text-5xl font-bold text-center leading-[1.25]">WELCOME TO LUMERÉ</h1>
          <p className="mt-4 text-lg italic">Your daily dose of excitement</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-16 max-w-7xl mx-auto my-15 items-center">
        ...
        <h2 className="text-3xl font-semibold mt-2 text-center col-span-1 md:col-span-3">
          OUR SPECIALTIES
        </h2>
        <SpotlightItems />
      </div>
